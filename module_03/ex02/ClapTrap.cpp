...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/16 15:28:51 by jsobreir          #+#    #+#             */
/*   Updated: 2024/12/16 15:28:52 by jsobreir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::beRepaired(unsigned int amount) {
	...
	{
		std::cout << "ClapTrap is repaired and gets " << amount << " hit points back!" << std::endl;
		_energyPoints--;
		_hitPoints += amount;
	}
